...
class SelfAttentionBlock(tf.keras.layers.Layer):
    """
    Self-attention block with multi-head attention and layer normalization
...
class LogitAdjustedLoss(tf.keras.losses.Loss):
    """
    Logit-Adjusted Loss for imbalanced datasets
    Based on: https://arxiv.org/abs/2006.07913
    """
...
def logit_adjusted_loss(class_priors, tau=1.0):
    """
    Functional implementation of Logit-Adjusted Loss
    """
...
class ESM2Embedding:
    """
    ESM2 embedding generator for prediction
    """
...
class HierarchicalNABPPredictor:
    def __init__(self, model_paths, esm2_model_path):
        """
        Initialize hierarchical predictor with ESM2-based models
        """
